        ...
        <div className="showcaselayout">
          ...
          <div className="project-list-wrapper overflow-hidden">
            <div className="project" ref={libraryRef}>
              ...
              Empowering brands with innovative digital solutions to boost visibility, engagement, and growth.
              </p>
            </div>
            ...
            <div className="project" ref={ycDirectoryRef}>
              ...
              Our vision is to lead in digital solutions by transforming brands through innovation, technology, and creative storytelling.
              </p>
            </div>
          </div>
        </div>
